...
public class TinderBoltApp extends MultiSessionTelegramBot {
    public static final String TELEGRAM_BOT_NAME = "My First AI Bot"; //TODO: добавь имя бота в кавычках
    public static final String TELEGRAM_BOT_TOKEN = "7480075773:AAH9gXwDCvOiCwpqW46RKgWJP_Rdz1M_v2g"; //TODO: добавь токен бота в кавычках
    ...
    public void onUpdateEventReceived(Update update) {
        ...
        if(currentMode == DialogMode.DATE && !isMessageCommand()){
            ...
            if(query.startsWith("date_")){
                ...
                sendTextMessage("Отличный выбор! \nТвоя задача пригласить его/ее на свидание за 5 сообщений.");
                String prompt = loadPrompt(query);
                chatGPT.setPrompt(prompt);
                return;
            }
            Message msg = sendTextMessage("Подождите девушка/парень набирает текст...");
        ...
        if(currentMode == DialogMode.PROFILE && !isMessageCommand()){
            switch (questionCount){
                ...
                case 3:
                    me.hobby = message;
                    questionCount = 4;
                    sendTextMessage("Что вам в людях не нравиться?");
                    return;
                case 4:
                    me.annoys = message;
                    questionCount = 5;
